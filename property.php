...
<!--	Title
	=========================================================-->
<title>Kenya AutoTruck Sales</title>
</head>
<body>
    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb1');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Asset Grid</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Asset Grid</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['9'];?>" alt="pimage">
                                        
                                        <div class="sale bg-secondary text-white">For <?php echo $row['5'];?></div>
                                        <div class="price text-primary text-capitalize">kshs<?php echo $row['6'];?> <span class="text-white"><?php echo $row['12'];?> </span></div>
