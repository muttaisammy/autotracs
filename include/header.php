                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-primary mr-1"></i>+254 724 052 417</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-primary mr-1"></i>info@kenstate.co.ke</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
